          ...
          <li class="h-full">
            ...
            >
              <div
                ...
                } w-4 sm:w-6 sm:h-6 h-4 rounded-full border-2 border-[#A3A3A3] p-2`}
                style={{
                  background:
                    "linear-gradient(to right, #7EB218 var(--dot-progress), #fff var(--dot-progress))",
                }}
              />
            </button>
          </li>
  ...
  return (
    <>
      <div class="flex items-center justify-center z-10 col-start-1 row-start-2">
        ...
        >
          <Icon
            class="text-default-inverse text-[#000] w-16 h-16"
            size={20}
            id="ChevronLeft"
            strokeWidth={3}
          />
